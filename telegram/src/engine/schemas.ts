...
/** Engine response schemas — strip unknown fields (engine may add non-breaking keys). */
...
export const ChangeLocationResponseSchema = z.object({
  success: z.boolean(),
  location: z
    .object({
      id: z.string(),
...
export const SubmitVerdictResponseSchema = z.object({
  correct: z.boolean(),
...
export const TelegramSnapshotSchema = z.object({
  case_id: z.string(),
