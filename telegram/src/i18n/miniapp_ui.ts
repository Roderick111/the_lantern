...
const en = {
  ...
  rites_hint: "Rites use spoken formulas. Type a formula alone or add a target after it. Questions do not perform rites.",
  copy_rite: "Copy rite formula",
  rite_copied: "Copied — paste it into the chat.",
  rite_copy_failed: "Copy failed. Select the formula and copy it manually.",
...
const ru: Record<keyof typeof en, string> = {
  ...
  rites: "Обряды — в чате",
  rites_hint: "Обряды требуют явной словесной формулы. Напишите формулу отдельно или добавьте после неё цель. Обычные вопросы обряд не вызывают.",
  copy_rite: "Скопировать формулу обряда",
  rite_copied: "Скопировано — вставьте формулу в чат.",
  rite_copy_failed: "Не удалось скопировать. Выделите формулу и скопируйте её вручную.",
